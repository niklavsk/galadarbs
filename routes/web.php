...
Route::resource('payroll', 'PayrollController', ['except' => ['index', 'show', 'store', 'create', 'edit', 'update', 'delete']])->middleware('auth');
...
Route::post('/payroll/create', 'PayrollController@store')->name('payroll_store')->middleware('auth');
