                    ...
                    <form action="{{action('VehicleController@update', ['id' => $vehicle->id])}}" method="post">
                        ...
                        <div class="form-group row {{ $errors->has('razosanas_datums') ? 'has-error' : ''}}">
                            ...
                            <input
                                ...
                                value="{{ $vehicle->razosanas_datums }}">
                        ...
                        <div class="form-group row {{ $errors->has('pedeja_remonta_datums') ? 'has-error' : ''}}">
                            ...
                            <input
                                ...
                                value="{{ $vehicle->pedeja_remonta_datums }}">
                        ...
                        <div class="form-group row {{ $errors->has('tehniskas_parbaudes_termins') ? 'has-error' : ''}}">
                            ...
                            <input
                                ...
                                value="{{ $vehicle->tehniskas_parbaudes_termins }}">
                        ...
                        <div class="form-group row {{ $errors->has('razotajs') ? 'has-error' : ''}}">
                            ...
                            <input class="form-control col-md-6 {{$errors->has('razotajs') ? ' is-invalid' : '' }}"
                                   name="razotajs"
                                   type="text" id="razotajs" value="{{ $vehicle->razotajs }}">
                            @if ($errors->has('razotajs'))
                                <span
                                    class="invalid-feedback text-md-center"><strong>{{ $errors->first('razotajs') }}</strong></span>
                            @endif
                        </div>
                            ...
                            <select name="depo_nr" size="1"
                                ...
                                @foreach($depots as $depot)
                                    <option value="{{ $depot->id }}"
                                            @if($depot->id == $vehicle->depo_nr) selected @endif>{{ $depot->id }}</option>
                                @endforeach
                            </select>

                            @if ($errors->has('depo_nr'))
                                <span
                                    class="invalid-feedback text-md-center"><strong>{{ $errors->first('depo_nr') }}</strong></span>
                            @endif
                        </div>
