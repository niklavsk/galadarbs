    ...
    <form action="{{action('RouteController@update', ['id' => $route->id])}}" method="post">
        ...
        <div class="col-4">
            ...
            <div class="form-group {{ $errors->has('nosaukums') ? 'has-error' : ''}}">
                ...
                <input class="form-control {{$errors->has('nosaukums') ? ' is-invalid' : '' }}" name="nosaukums" type="text" id="nosaukums" value="{{ $route->nosaukums }}">
            ...
            <div class="form-group {{ $errors->has('apraksts') ? 'has-error' : ''}}">
                ...
                <input class="form-control {{$errors->has('apraksts') ? ' is-invalid' : '' }}" name="apraksts" type="text" id="apraksts" value="{{ $route->apraksts }}">
            ...
            <a href="{{ action('RouteController@addStop_edit', $route->id) }}" class="btn">Pievienot pieturu</a>
            <a href="{{ action('RouteController@removeStop_edit', $route->id) }}" class="btn">Noņemt pieturu</a>
